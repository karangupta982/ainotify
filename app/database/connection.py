"""Database engine/session helpers for SQLAlchemy."""
...
def get_environment() -> str:
    """Return current environment marker (LOCAL/PRODUCTION)."""
    return os.getenv("ENVIRONMENT", "LOCAL").upper()


def get_database_url() -> str:
    """Build a database URL from env vars, fixing old postgres:// schemas."""
...
def get_database_info() -> dict:
    """Return masked DB info for logging/diagnostics."""

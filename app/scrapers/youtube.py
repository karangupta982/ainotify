"""YouTube channel scraper + transcript fetcher."""
...
class Transcript(BaseModel):
    """Minimal transcript wrapper to keep types explicit."""

    text: str


class ChannelVideo(BaseModel):
    """Metadata we persist for each video plus optional transcript text."""
